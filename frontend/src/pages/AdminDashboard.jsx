            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-gradient-purple-teal rounded-2xl shadow-xl p-8 mb-8 text-white">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold mb-1">System Overview & Student Management</h2>
                            <p className="text-purple-100">Welcome, {user?.fullName}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Admin Info Card */}
                <div className="card">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Admin Profile</h3>
